    ...
    columns: [
      ...
      },
      {
        ...
        render: function (data, type, row) {
          if (row.event == 'ENTERQUEUE') {
            ...
            return "<span class='label label-success' style='background-color: #28a745; color: white;'><i class='fa fa-lock'></i>&nbsp;&nbsp;LLAMADA ENCRYPTADA</span>";
      ...
      },
      {
        ...
        render: function (data, type, row) {
          if (row.event === "ENTERQUEUE") {
            if (data === null) {
              return "<button style='font-size:13px;' type='button' class='calificar btn btn-warning' title='Calificar Llamada'><i class='fa fa-star'></i>&nbsp;<strong>Calificar</strong></button>";
            } else {
              return "<button style='font-size:13px;' type='button' class='calificar btn btn-danger' title='Llamada Calificada' disabled><i class='fa fa-star'></i>&nbsp;<strong>Calificado</strong></button>";
            }
          } else {
            return "";
          }
